...
const sendNotification = async (userIds: string[], notification: NotificationForm): Promise<void> => {
  try {
...
function AdminDashboard() {
  ...
  const [userProfile, setUserProfile] = useState<UserProfile>({ name: 'Admin', avatar: null })
  ...
  const handleSubmitNotification = async (values: NotificationForm): Promise<void> => {
    setSending(true)
    const data = {
